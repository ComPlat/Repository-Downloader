  ...
  describe "/api/swagger_doc.json" do
    let(:expected_body) do
      {info: {title: "Chemotion Repository Downloader", version: "v1"},
       ...
       paths: {"/v1/publications": {get: {description: "Get publications via ChemotionID(s) or DOI(s)", operationId: "getV1Publications", parameters: [{collectionFormat: "csv", description: "List of DOIs, separated by comma, either this or chemotion_ids needs to be given", in: "query", items: {type: "string"}, name: "dois", required: false, type: "array"}, {collectionFormat: "csv", description: "List of Chemotion IDs, separated by comma, either this or dois needs to be given", in: "query", items: {format: "int32", type: "integer"}, name: "chemotion_ids", required: false, type: "array"}], produces: ["application/json", "application/xml", "text/csv", "application/zip"], responses: {"200": {description: "Get publications via ChemotionID(s) or DOI(s)"}}, tags: ["publications"]}}, "/v1/publications/search": {get: {description: "Search publications via authors and/or contributor and/or description", operationId: "getV1PublicationsSearch", parameters: [{collectionFormat: "tsv", description: "List of Authors, only finds exact matches by name", in: "query", items: {type: "string"}, name: "authors_value", required: false, type: "array"}, {collectionFormat: "tsv", description: "Must be either EQUAL or LIKE", in: "query", items: {type: "string"}, name: "authors_search_operator", required: false, type: "array"}, {description: "Single Contributor, only finds matches by name", in: "query", name: "contributor_value", required: false, type: "string"}, {enum: ["EQUAL", "LIKE"], in: "query", name: "contributor_search_operator", required: true, type: "string"}, {description: "Searches description for a single search term", in: "query", name: "description_value", required: false, type: "string"}, {enum: ["EQUAL", "LIKE"], in: "query", name: "description_search_operator", required: true, type: "string"}, {description: "Searches for items published before the given date", format: "date", in: "query", name: "published_before", required: false, type: "string"}, {description: "Searches for items published after the given date", format: "date", in: "query", name: "published_after", required: false, type: "string"}, {description: "Searches for items with yield over the given value", format: "float", in: "query", name: "yield_over", required: false, type: "number"}, {description: "Searches for items with yield under the given value", format: "float", in: "query", name: "yield_under", required: false, type: "number"}], produces: ["application/json", "application/xml", "text/csv"], responses: {"200": {description: "Search publications via authors and/or contributor and/or description"}}, tags: ["publications"]}}}, produces: %w[application/json text/csv application/zip application/xml]}
    end
