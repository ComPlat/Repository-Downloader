describe ReactionPresenter do
  ...
  describe "#to_zip" do
    ...
    context "when reaction has minimal attributes" do
      ...
      it { expect(File.read("tmp/data/output/data/reaction.json")).to eq reaction_presenter.to_json.to_a.join }
      it { expect(File.read("tmp/data/output/data/reaction.xml")).to eq reaction_presenter.to_xml.to_a.join }
      it { expect(File.read("tmp/data/output/data/reaction.csv")).to eq reaction_presenter.to_csv.to_a.join }
    end
